...
const _FIELD_NAMES = ["fullName", "email", "phone", "address", "password"] as const;
...
const FORM_ID = "registrationForm"; // 1.31 kB
    ...
    <div className="flex grow">
      <Card className="m-auto min-w-1/2">
        <CardHeader className="*:text-center">
          ...
          <CardDescription>Create an account to access your order history.</CardDescription>
        </CardHeader>
        <CardContent>
